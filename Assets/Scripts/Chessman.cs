...
public class Chessman : MonoBehaviour
{
    ...
    {
        PointerMovePlate(xBoard + 1, yBoard + 2);
        PointerMovePlate(xBoard - 1, yBoard + 2);
        PointerMovePlate(xBoard + 2, yBoard + 1);
        PointerMovePlate(xBoard + 2, yBoard - 1);
        PointerMovePlate(xBoard + 1, yBoard - 2);
        PointerMovePlate(xBoard - 1, yBoard - 2);
        PointerMovePlate(xBoard - 2, yBoard + 1);
    ...
    {
        PointerMovePlate(xBoard , yBoard +1);
        PointerMovePlate(xBoard , yBoard -1);
        PointerMovePlate(xBoard - 1 , yBoard - 1);
        PointerMovePlate(xBoard - 1 , yBoard - 0);
        PointerMovePlate(xBoard - 1 , yBoard + 1);
        PointerMovePlate(xBoard + 1 , yBoard - 1);
        PointerMovePlate(xBoard + 1 , yBoard - 0);
        PointerMovePlate(xBoard + 1 , yBoard + 1);
    ...
    public void PointerMovePlate( int x, int y)
    {
        Game sc = controller.GetComponent<Game>();
